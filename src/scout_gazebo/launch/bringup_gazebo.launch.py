...
def generate_launch_description():
    robot_name = DeclareLaunchArgument("robot_name", default_value="scout")
    ...
    gz_resource_path = SetEnvironmentVariable(name='GAZEBO_MODEL_PATH', value=[
                                    ...
                                    str(Path(get_package_share_directory('scout_description')).parent.resolve()),
                                    ':',
                                    str(Path(get_package_share_directory('scout_gazebo')).parent.resolve()) + "/scout_gazebo/models",
                        ])
